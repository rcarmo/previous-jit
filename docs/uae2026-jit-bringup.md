...
- latest audit validation (2026-05-15): opcode harness `/workspace/tmp/previous-opcode-harness-audit-20260515-114558` (`pass=62 fail=0 score=100`); default/ROM stable smoke `/workspace/tmp/previous-jit-audit-default-20260515-115126` (`desktop_reached=1 stable_reached=1`, `jit_last_pc=0100bb08`); guard-on RAM audit run `/workspace/tmp/previous-jit-audit-guard-ram-20260515-115703` reached `root on sd@` in OCR and continued in post-root kernel/hardclock activity before the outer tool timeout, with no desktop yet.
