...
- current RAM-mode frontier after the RTE-state fix is a repeated `MOVES.L D0,(A0)` DFC write fault at `040014b2` (`op=0e90 ext=0800`, `addr=03f7fffc`, `dfc=1`) with handler return through `04001f52`; RAM mode still fails before desktop in `/workspace/tmp/previous-jit-bridge-smoke-rte-state-ram-20260513-232254` (`jit_dispatch_lines=329616`, `jit_last_pc=0405f748`)
