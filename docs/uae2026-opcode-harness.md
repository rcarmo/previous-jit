...
- new RAM/MMU fixes should keep the fast MMU smoke at `pass=31 fail=0 score=100` and the full opcode harness at `pass=74 fail=0 score=100` before heavier boot smokes are trusted
